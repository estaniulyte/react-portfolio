...
import { Illustrations } from '../data/IllustrationsData';
    ...
    >
      <Container>
        ...
        <Center>
          <Grid>
            {
              Illustrations.map(blog => {
                return <IllustrationComponent key={blog.id} blog={blog} />
              })
            }
          </Grid>
        </Center>
        <BigTitle text="Graphic Design" top="5rem" left="5rem" />
      </Container>
    </MainContainer>
  )
}
